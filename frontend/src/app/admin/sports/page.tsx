...
import {
    getSportsPageContent,
    updateSportsPageContent,
    defaultSportsPageContent,
    SportsPageContent,
} from "@/lib/sportsPageContent";
...
export default function SportsAdminPage() {
    ...
    const handleSave = async () => {
        ...
        const success = await updateSportsPageContent(content);
        setIsSaving(false);
    ...
    const handleReset = () => {
        setContent(defaultSportsPageContent);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="font-montserrat font-bold text-2xl text-brand-blue">Sports Page</h1>
                    <p className="text-brand-gray font-poppins text-sm mt-1">Manage content for the Sports page</p>
                </div>
                <button onClick={handleSave} disabled={isSaving} className={cn("flex items-center gap-2 px-5 py-2 bg-brand-blue text-white font-poppins font-medium rounded-lg shadow-md transition-all", isSaving ? "opacity-70 cursor-not-allowed" : "hover:bg-brand-blue/90")}>
                    {isSaving ? <Loader2 className="w-4 h-4 animate-spin" /> : <Save className="w-4 h-4" />}
            ...
            <div className="space-y-4">
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <SectionHeader id="hero" title="Hero Section" icon={<Trophy className="w-5 h-5 text-brand-blue" />} />
                    <AnimatePresence>
                ...
                {/* ── Mission Section ── */}
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <SectionHeader id="mission" title="Mission & Impact" icon={<Megaphone className="w-5 h-5 text-brand-blue" />} />
                    <AnimatePresence>
